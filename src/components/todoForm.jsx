...
export const TodoForm = ({OnSubmit, onCancel, initialValue = '', placeholder}) => {
  ...
  return (
    <form className='flex items-center gap-3' onSubmit={handleSubmit}>
      ...
      <div className='flex items-center gap-2'>
        ...
        <button type='submit' className='flex items-center justify-center w-10 h-10 bg-gray-600 hover:bg-gray-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-lg transition-colors duration-200' title='Delete Todo'>
          <X size={18}/>
        </button>
      </div>
    </form>
